...
export const FILE_COPIES = [
  ...
  // skills.sh removed — no longer needed (Strike Team eliminated)
  ...
  { repoRel: 'agents/sub/code-exploration.md', configRel: 'agents/code-exploration.md', executable: false },
  { repoRel: 'agents/sub/root-cause-analysis.md', configRel: 'agents/root-cause-analysis.md', executable: false },
  { repoRel: 'agents/sub/task-planner.md', configRel: 'agents/task-planner.md', executable: false },
];
